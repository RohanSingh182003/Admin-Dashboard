    ...
    <>
        ...
        <div className='w-10/12 relative min-h-full bg-gray-700 rounded-md flex justify-evenly p-4'>
          <div className="w-9/12 pl-3 pr-5">
            ...
            <div className="h-80 w-full rounded-lg shadow-2xl my-3 flex justify-evenly">
              ...
              <div className="min-w-[26rem] h-full bg-gray-800 p-4 rounded-lg rounded-l flex flex-wrap justify-center items-center relative">
                {/* reverse */}
          ...
          {rightbar && <div onClick={() => { setRightbar( !rightbar ) }} className="flex flex-col items-center justify-start mx-2 z-10 absolute right-4 top-2 bg-gray-800 py-4 rounded-lg">
      ...
      <section className="lg:hidden bg-gray-900 h-full overflow-x-hidden">
        <nav className="flex items-center justify-between py-2 border-b relative">
          ...
          <div onClick={toggleSidebar} ref={ref} className="absolute shadow-xl bg-gray-800 top-0 right-0 h-[100vh] py-12 px-4 transition-transform translate-x-full transform">
