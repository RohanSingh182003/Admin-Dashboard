...
function App() {
  ...
  return (
    <BrowserRouter>
    <section className="flex flex-col bg-gray-900 h-full lg:p-10">
      <div className='flex flex-col lg:flex-row justify-evenly'>
        ...
        <div className='w-full h-14 lg:w-2/12 relative lg:h-[90vh]'>
          ...
          <div className="flex items-center my-1 lg:my-4 lg:ml-4 mt-2"><GiFuelTank className="ml-8 mr-2 -mt-1" /> <p>Fuel</p>
          </div>
          ...
          <div ref={ref} className='my-12 px-6 lg:px-0 py-14 lg:py-0 transform transition-transform -translate-x-full lg:translate-x-0 z-10 h-[100vh] absolute -top-10 bg-gray-900 left-0'>
            ...
            <ul className='flex flex-col items-center space-y-5'>
              <Link to={"/"} className='w-40 text-gray-300 flex items-center cursor-pointer font-semibold -ml-10'><div className="flex items-center my-1 lg:my-4 lg:ml-4 text-3xl text-blue-500 -mt-4 lg:mt-0"><GiFuelTank className="ml-8 mr-2 -mt-1" /> <p>Fuel</p>
          </div></Link>
